public class Test {
    ...
    public static void main(String[] args) {
        ...
        Carte c1 = new Carte(Parcelle.chemin, Parcelle.plaine, Parcelle.chemin, Parcelle.plaine, Parcelle.chemin);
        int i = 9;
        for (int y = 0; y < i; y++) {
            deck.AddCarte(c1);
        }
        Carte c2 = new Carte(Parcelle.chemin, Parcelle.ville, Parcelle.chemin, Parcelle.chemin, Parcelle.plaine);
        i = 3;
        for (int y = 0; y < i; y++) {
            deck.AddCarte(c2);
        }
        Carte c3 = new Carte(ville, ville, chemin, chemin, ville);
        i = 2;
        for (int y = 0; y < i; y++) {
            deck.AddCarte(c3);
        }
